...
Bytes AESCipher::encrypt(ByteView plain_text) {
    ...
    EVP_EncryptUpdate(ctx_, cipher_text.data(), &cipher_text_len, plain_text.data(), static_cast<int>(plain_text.size()));
...
Bytes AESCipher::decrypt(ByteView cipher_text) {
    ...
    EVP_DecryptUpdate(ctx_, plain_text.data(), &plain_text_len, cipher_text.data(), static_cast<int>(cipher_text.size()));
